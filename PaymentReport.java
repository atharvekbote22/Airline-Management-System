...
public class PaymentReport extends javax.swing.JFrame {
    ...
    public PaymentReport() {
         ...
         try
        {
            //Class.forName("com.mysql.jdbc.Driver");  
             ...
             while(rs.next())
             {
                String TID=String.valueOf(rs.getInt("Ticket_Id"));
                ...
                String FID=String.valueOf(rs.getInt("Flight_No"));
                ...
                String Passport=rs.getString("Passport_No");
                  ...
                  String tbData[]={TID,CID,Name,Mob,Address,Aadhar,FID,FName,Source,Destination,Fare,Passport};
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(600, 140, 260, 70);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ticket_Id", "Customer_Id", "Customer_Name", "Mobile_No", "Address", "Aadhar_No", "Flight_No", "Flight_Name", "Source", "Destination", "Fare", "Passport_No"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(50, 270, 1280, 240);
        ...
        jLabel3.setBounds(0, -60, 1620, 870);
