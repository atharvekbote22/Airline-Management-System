 ...
 * @author BHAVESH
 */
public class FlightReport extends javax.swing.JFrame {
    ...
    public FlightReport() {
         ...
         try
        {
            //Class.forName("com.mysql.jdbc.Driver");  
             ...
             while(rs.next())
             {
                String ID=String.valueOf(rs.getInt("Flight_No"));
                ...
                String Fare=rs.getString("Fare");
                  ...
                  String tbData[]={ID,Name,Source,Destination,Fare};
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(380, 30, 670, 86);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Flight_ID", "Flight_Name", "Source", "Destination", "Fare"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(240, 280, 820, 402);
        ...
        jLabel3.setBounds(0, -110, 1380, 970);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FlightReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FlightReport().setVisible(true);
            }
        });
    }
