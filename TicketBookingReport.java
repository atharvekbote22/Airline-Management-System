 ...
 * @author BHAVESH
 */
public class TicketBookingReport extends javax.swing.JFrame {

    /** Creates new form TicketBookingReport */
    public TicketBookingReport() {
        initComponents();
         ...
         try
        {
            //Class.forName("com.mysql.jdbc.Driver");  
             ...
             while(rs.next())
             {
                ...
                String Aadhar=rs.getString("Aadhar_Card");
                String FID=String.valueOf(rs.getInt("Flight_ID"));
                ...
                String Passport=rs.getString("Passport_No");
                  ...
                  String tbData[]={BID,CID,Name,Mob,Address,Aadhar,FID,FName,Source,Destination,Fare,Passport};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TICKET BOOKING REPORT");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(570, 140, 370, 70);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Booking_ID", "Customer_ID", "Customer_Name", "Mob_No", "Address", "Aadhar_Card", "Flight_ID", "Flight_Name", "Source", "Destination", "Fare", "Passport_No"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(70, 280, 1230, 250);
        ...
        jLabel3.setBounds(0, -90, 1540, 920);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicketBookingReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TicketBookingReport().setVisible(true);
            }
        });
    }
